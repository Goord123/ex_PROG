...
void func( int tam, int arr[tam][3]) {
    ...
    if (arr[0][0] == arr[1][0] || arr[0][0] == arr[2][0] || arr[1][0] == arr[2][0]) {
        printf("Os valores introduzidos tem de ser diferentes\n");
        return;
    }
    if (arr[0][0] < 1 || arr[0][0] > 100 ||
    arr[1][0] < 1 || arr[1][0] > 100 || arr[2][0] < 1 || arr[2][0] > 100) {
            printf("Os valores introduzidos tem de estar entre 1 e 100\n");
            return;
    }
